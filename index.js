...
console.log('task 1a:', easton);
easton.eat('pizza')
console.log('task 1b:', easton.stomach);
console.log('task 1c:', easton.toString());
...
const mustang = new Car('2020 Mustang GT', 21);

console.log('task 2a:', mustang.fill(6));
console.log('task 2b:', mustang.drive(100));
console.log('task 2c:', mustang.drive(35));
...
const jokim = new Lambdasian('Jo Kim', 35, 'Korea');

console.log('task 3:', jokim.speak());
